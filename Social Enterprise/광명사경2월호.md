...
- **임팩트**: 전 세계 13개국 120만 그루 이상의 나무 식재
- **검증 자료**:  
...
- **기술 혁신 포인트**:  
  ...
  - 데이터 기반 역량 성장 추적 시스템  
- **임팩트**: 80명 이상의 발달장애인 고용, 평균 시장 임금의 2배 이상 급여 실현
- **검증 자료**:  
  - [오티스타 공식 웹사이트](https://www.autistar.co.kr/)  
...
- **임팩트**: 취약계층 100명 이상 고용, 이커머스 물류 처리 효율 40% 향상
- **검증 자료**:  
  - [두손컴퍼니 공식 웹사이트](https://www.doosoun.com/)  
...
- **검증 자료**:  
  ...
  - [빌&멜린다 게이츠 재단 지원 프로젝트 보고서](https://www.gatesfoundation.org/ideas/articles/simprints-digital-id)
